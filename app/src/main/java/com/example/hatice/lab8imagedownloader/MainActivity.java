package com.example.hatice.lab8imagedownloader;
...
//                preview(imagePath);
    ...
    class DownloadTask extends AsyncTask<String, Integer, Bitmap>{
        ...
        protected Bitmap doInBackground(String... strings) {
            ...
            return scaledBitmap(imagePath + "/" + fileName);
        }
    ...
    class DownloadRunnable implements Runnable {
        ...
        public void run() {
            String filename = "temp.jpg";
            String imagePath = (Environment.getExternalStorageState(new File(Environment.DIRECTORY_DOWNLOADS)).toString());
            downloadFile(url,imagePath + "/" + filename );
            Bitmap bitmap = scaledBitmap(imagePath + "/" + filename);
